...
class Point {
  ...
  // Implementation of the equals method that is defined in the Object class.
  // This method OVERRIDEs the equals method in the Object class.
  public boolean equals(Object other) {
    System.out.println("Calling our equals!");
    if(other == null) {
      return false;
    }
...
class Equality {
  ...
  Point[] points1 = {p, p2};
  Point[] points2 = {p2, p};
  boolean pointsEqualByArrayEquals = Arrays.equals(points1, points2);
  ...
  // calls .equals() on all elements if they are objects, or compares with == if
  // they are prims
